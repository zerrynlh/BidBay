...
class Listing(models.Model):
    """Listing model with restricted choices"""
...
class Bid(models.Model):
    ...
    #Stops date from being saved every time the object
    #is saved but automically adds time on first entry
    date = models.DateTimeField(auto_now=False, auto_now_add=True)
...
class Comments(models.Model):
    ...
    """Stops datetime from being saved every time the 
    object is saved but automically adds time on first entry"""
